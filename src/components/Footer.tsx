...
const Footer = () => {
  return (
    <footer className="bg-[#0A1A2F] relative overflow-hidden">
      {/* 顶部斜切色带 */}
      ...
      <div className="hidden md:block">
        ...
        <div className="container mx-auto px-4 relative pt-16 pb-8">
          <div className="grid grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link to="/workout" className="text-primary-200/70 hover:text-accent-400 transition-colors text-sm">
                    训练记录
                  </Link>
                </li>
                <li>
      ...
      {/* ============ 手机版紧凑页脚（<md） ============ */}
      <div
        className="md:hidden px-4 pt-6 text-center"
      ...
      >
        ...
        <p className="text-primary-200/50 text-xs mb-4 leading-relaxed px-2">
          AI 教练 · 专业课程 · 健身社区
        </p>
        <div className="flex items-center justify-center gap-5 text-[11px] text-primary-200/50 mb-3">
          ...
          <Link to="/meal-plan" className="hover:text-accent-400 transition-colors">
            饮食计划
          </Link>
        </div>
        <p className="text-primary-200/30 text-[10px]">© 2024 FitZone · 让健身更科学</p>
      </div>
    </footer>
  );
};
