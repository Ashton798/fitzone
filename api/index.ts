...
// 小程序标题字体走 FitZone 自有 API 域名，真机只需配置一个合法域名。
...
app.get('/api/assets/fonts/:font', async (req: any, res: any) => {
...
app.get('/api/auth/me', authenticateToken, (req: any, res: any) => {
  ...
  res.json({
    ...
    experience: user.experience, experienceLevel: user.experienceLevel || 'beginner',
    ...
    profileVisibility: user.profileVisibility || 'public', createdAt: user.createdAt
  });
});
